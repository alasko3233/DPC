    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <form action="{{ route('manage-new.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                            ...
                            <input
                                ...
                                type="text" name="details" id="add-input" value="{{ old('name') ?? '' }}"
                        ...
                        <div class="col-md-12 col-md-12 col-xl-12 col-xxl-12 col-sm-12 my-2" id="add-cls">
                            ...
                            <textarea id="summernote" name="editordata" rows="5" cols="33"
                                class="form-control rounded border-success {{ $errors->has('contenu') ? 'is-invalid' : '' }}"> </textarea>
                            @error('contenu')
                                <div class="help-block invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
