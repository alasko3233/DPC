        ...
        <div class="col-md-10">
            <div class="text-center">
                <div class='row justify-content-center mx-1 mt-4'>
                    <span class="col-md-12 col-xl-12 col-xll-12 col-sm-12 rounded-pill mb-2 text-uppercase smalls pe-none"> Modifier - Membres</span>
                    <hr style="height: 6px;" class="bg-success">
                </div>
            </div>

            <form action="{{route('manage-membre.update',$membre->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                        ...
                        <input class="form-control rounded border-success {{ $errors->has('firstname') ? 'is-invalid' : '' }}" type="text" name="prenom" id="add-input" value="{{ old('prenom') ?? $membre->lastname }}" placeholder="Saisissez le prenom">
                        @error('name')
                    ...
                    <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                        ...
                        <input class="form-control rounded border-success {{ $errors->has('firstname') ? 'is-invalid' : '' }}" type="text" name="name" id="add-input" value="{{ old('name') ?? $membre->firstname }}" placeholder="Saisissez le nom">
                        @error('name')
                            <div class="help-block invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                        ...
                        <input class="form-control rounded border-success {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="add-input" value="{{ old('phone') ?? $membre->phone }}" placeholder="Saisissez le numéro de téléphone ">
                        @error('phone')
                            <div class="help-block invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                        ...
                        <input class="form-control rounded border-success {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="add-input" value="{{ old('email') ?? $membre->email }}" placeholder="Saisissez l' e-mail">
                        @error('email')
                            <div class="help-block invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                        ...
                        <input class="form-control rounded border-success {{ $errors->has('poste') ? 'is-invalid' : '' }}" type="text" name="poste" id="add-input" value="{{ old('poste') ?? $membre->poste }}" placeholder="Saisissez son poste">
                        @error('email')
                            <div class="help-block invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6 col-xl-6 col-xxl-6 col-sm-6 my-2 my-2">
                        <label class="form-label fw-bolder text-uppercase label_color" >Changer l'image</label>
                        <small class="text-success">changer image </small>
