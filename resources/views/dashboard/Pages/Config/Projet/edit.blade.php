        ...
        <div class="col-md-10">
            <div class="text-center">
                <div class='row justify-content-center mx-1 mt-4'>
                    <span class="col-md-12 col-xl-12 col-xll-12 col-sm-12 rounded-pill mb-2 text-uppercase smalls pe-none"> Modifier -  projet</span>
                    <hr style="height: 6px;" class="bg-success">
                </div>
            </div>

            <form action="{{route('manage-projet.update',$projet->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-12 col-md-12 col-xl-12 col-xxl-12 col-sm-12 my-2" id="add-cls">
                        ...
                        <textarea id="summernote" name="contenu" rows="5" cols="33"  class="form-control rounded border-success {{ $errors->has('contenu') ? 'is-invalid' : '' }}">{{$projet->contenu}} </textarea>
                        @error('contenu')
                            <div class="help-block invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
