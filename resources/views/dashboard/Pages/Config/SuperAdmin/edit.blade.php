...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <form action="{{route('manage-superadmin.update',$user->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                        ...
                        <input class="form-control rounded border-success {{ $errors->has('firstname') ? 'is-invalid' : '' }}" type="text" name="name" id="add-input" value="{{ old('name') ?? $user->name }}" placeholder="Saisissez le nom">
                        @error('name')
                    ...
                    <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                        ...
                        <input class="form-control rounded border-success {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="add-input" value="{{ old('phone') ?? $user->phone }}" placeholder="Saisissez le numéro de téléphone ">
                        @error('phone')
                            <div class="help-block invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                        ...
                        <input class="form-control rounded border-success {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="add-input" value="{{ old('email') ?? $user->email }}" placeholder="Saisissez l' e-mail">
                        @error('email')
                            <div class="help-block invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
