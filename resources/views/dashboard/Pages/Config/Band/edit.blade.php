        ...
        <div class="col-md-10">
            <div class="text-center">
                <div class='row justify-content-center mx-1 mt-4'>
                    <span class="col-md-12 col-xl-12 col-xll-12 col-sm-12 rounded-pill mb-2 text-uppercase smalls pe-none"> Modifier -  Bandrolls</span>
                    <hr style="height: 6px;" class="bg-success">
                </div>
            </div>

            <form action="{{route('manage-band.update',$projet->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                        ...
                        <input class="form-control rounded border-success {{ $errors->has('dated') ? 'is-invalid' : '' }}" type="text" name="dated" id="add-input" value="{{ old('dated') ?? $projet->date_d }}" placeholder="Saisissez le numéro de téléphone ">
                        @error('dated')
                    ...
                    <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                        ...
                        <input class="form-control rounded border-success {{ $errors->has('datef') ? 'is-invalid' : '' }}" type="text" name="datef" id="add-input" value="{{ old('datef') ?? $projet->date_f }}" placeholder="Saisissez le numéro de téléphone ">
                        @error('datef')
                            <div class="help-block invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                        <label id="add-label" class="form-label fw-bolder" for="name">Zone</label>
                        <input class="form-control rounded border-success {{ $errors->has('firstname') ? 'is-invalid' : '' }}" type="text" name="name" id="add-input" value="{{ old('name') ?? $projet->name }}" placeholder="Saisissez le nom">
                        @error('name')
                            <div class="help-block invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    {{-- <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                        ...
                        <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }} border-success" name="status" id="inputPassword">
                            ...
                            <option value="first">Projet en cour</option>
                            <option value="second">Projet realisé</option>
                    ...
                    <div class="col-md-12 col-md-12 col-xl-12 col-xxl-12 col-sm-12 my-2" id="add-cls">
                        ...
                        <textarea id="story" name="contenu" rows="5" cols="33"  class="form-control rounded border-success {{ $errors->has('contenu') ? 'is-invalid' : '' }}"> </textarea>
                        @error('contenu')
                            <div class="help-block invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
