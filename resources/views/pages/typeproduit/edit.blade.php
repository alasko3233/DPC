                ...
                <div class="text-center">
                    <div class='row justify-content-center mx-1 mt-4'>
                        <span
                            ...
                            Modifier - Type Produit</span>
                        <hr style="height: 6px;" class="bg-success">
                    </div>
                </div>

                <form action="{{ route('type_produit.update', $item) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                            ...
                            <input
                                ...
                                type="text" name="name" id="add-input" value="{{ old('name') ?? $item->nom_type }}"
                        ...
                        <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                            ...
                            <input
                                ...
                                type="number" name="prix_f" id="add-input" value="{{ old('prix_f') ?? $item->prix_f }}"
                        ...
                        <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                            ...
                            <input
                                ...
                                type="number" name="prix_v" id="add-input" value="{{ old('prix_v') ?? $item->prix_v }}"
                                placeholder="Saisissez le Prix">
                            @error('prix_v')
                                <div class="help-block invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-3 col-md-3 col-xl-3 col-xxl-3 col-sm-6 my-2" id="add-cls">
                            ...
                            <input
                                ...
                                type="number" name="prix_c" id="add-input" value="{{ old('prix_c') ?? $item->prix_c }}"
                                placeholder="Saisissez le Prix">
                            @error('prix_c')
                                <div class="help-block invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-md-8 col-xl-8 col-xxl-8 col-sm-8 my-2  my-2">
                            ...
                            <div class="row justify-content-center mx-4 my-2">
                                <button type="submit"
                                    class="btn btn-success col-md-6 col-xl-6 col-sm-6  col-xxl-6 rounded-pill smalls">Modifer
