            ...
            <div class="contact wow fadeInUp">
                <div class="container">
                    <div class="section-header text-center">
                        {{-- <p>Get In Touch</p> --}}
                        <h2>Pour toutes vos questions</h2>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="contact-info">
                                <div class="contact-item">
                                    ...
                                    <div class="contact-text">
                                        <h2>Localité</h2>
                                        <p>Immeuble GEOCOM Rue 778 Porte 423 BANANKABOUGOU </p>
                                    </div>
                                </div>
                                <div class="contact-item">
                                    ...
                                    <div class="contact-text">
                                        <h2>Phone</h2>
                                        <p>(+223) 66 73 42 07/ 73 43 15 38</p>
                                    </div>
                                </div>
                                <div class="contact-item">
                            ...
                            <div class="contact-form">
                                ...
                                <form name="sentMessage" id="contactForm" novalidate="novalidate">
                                    <div class="control-group">
                                        <input type="text" class="form-control" id="name" placeholder="Nom Complet" required="required" data-validation-required-message="Please enter your name" />
